...
export const TERM_PROFESSORS: Record<string, Professor[]> = {
  ...
  "Term 3": [
    {
      name: "Safwat Hamad",
      email: "safwat.hamad@faculty.opit.com",
      courseCode: "COMP-3001",
      courseName: "Introduction to Databases",
      liveSessions: "Saturdays 12:00–13:30 (Malta)",
      meetingId: "834 3775 0072",
      passcode: "824383",
      recordingPassword: "COMP-3001-fall-2026intake",
      officeHours: "Even weeks (2,4,6,8,10,12) · Saturdays 13:30–14:30 (Malta)",
      tutors: ["Durba Srivastava", "Sugandha Rathi"],
    },
    {
      name: "Lokesh Vij",
      email: "lokesh.vij@faculty.opit.com",
      courseCode: "COMP-3002",
      courseName: "Cloud Computing Infrastructure",
      liveSessions: "Mondays 12:00–13:30 (Malta)",
      meetingId: "874 6131 0700",
      passcode: "183124",
      recordingPassword: "COMP-3002-fall-2026intake",
      officeHours: "Even weeks (2,4,6,8,10,12) · Mondays 18:00–19:00 (Malta)",
      tutors: ["Sugandha Rathi", "Durba Srivastava"],
    },
    {
      name: "Charbel Fares",
      email: "charbel.fares@faculty.opit.com",
      courseCode: "COMP-3003",
      courseName: "Programming Paradigms",
      liveSessions: "Tuesdays 15:00–16:30 (Malta)",
      meetingId: "835 5016 6500",
      passcode: "727736",
      recordingPassword: "COMP-3003-fall-2026intake",
      officeHours: "Even weeks (2,4,6,8,10,12) · Tuesdays 17:30–18:30 (Malta)",
      tutors: ["Arush Kaushal", "Himanshi Agrawal"],
    },
    {
      name: "Raj Dasgupta",
      email: "raj.dasgupta@faculty.opit.com",
      ...
      liveSessions: "Fridays 12:00–13:30 (Malta)",
      meetingId: "854 2600 8344",
      passcode: "088055",
      recordingPassword: "COMP-3004-fall-2026intake",
      officeHours: "Even weeks (2,4,6,8,10,12) · Fridays 13:30–14:30 (Malta)",
      tutors: ["Himanshi Agrawal", "Yash Raj Verma"],
    },
    {
      name: "Francesco Derchi",
      email: "francesco.derchi@faculty.opit.com",
      courseCode: "COMP-3005",
      courseName: "Business Strategy",
      liveSessions: "Wednesdays 13:30–15:00 (Malta) — 1st session: Mon Sep 21, 14:30–16:00",
      meetingId: "875 6919 9851",
      passcode: "304670",
      recordingPassword: "COMP-3005-fall-2026intake",
      officeHours: "Even weeks (2,4,6,8,10,12) · Fridays 08:00–09:00 (Malta)",
      tutors: ["Ankita Shukla", "Appurwa Saxena"],
    },
  ],
}
...
export const initialAssessments: Assessment[] = [
  ...
  // ── TERM 3 ──────────────────────────────────────────────────────────────
  { id: "t3-a1", title: "Assessment 1", courseCode: "COMP-3001", course: "Introduction to Databases",          deadline: "Nov 22",       weight: "60%",   status: "todo" },
  { id: "t3-a2", title: "Assessment 2", courseCode: "COMP-3001", course: "Introduction to Databases",          deadline: "Jan 10, 2027", weight: "40%",   status: "todo" },
  { id: "t3-b1", title: "Assessment 1", courseCode: "COMP-3002", course: "Cloud Computing Infrastructure",     deadline: "Dec 20",       weight: "60%",   status: "todo" },
  { id: "t3-b2", title: "Assessment 2", courseCode: "COMP-3002", course: "Cloud Computing Infrastructure",     deadline: "Dec 27",       weight: "40%",   status: "todo" },
  { id: "t3-c1", title: "Assessment 1", courseCode: "COMP-3003", course: "Programming Paradigms",              deadline: "Oct 25",       weight: "10%",   status: "todo" },
  { id: "t3-c2", title: "Assessment 2", courseCode: "COMP-3003", course: "Programming Paradigms",              deadline: "Nov 15",       weight: "30%",   status: "todo" },
  { id: "t3-c3", title: "Assessment 3", courseCode: "COMP-3003", course: "Programming Paradigms",              deadline: "Dec 30",       weight: "30%",   status: "todo" },
  { id: "t3-d1", title: "Assessment 1", courseCode: "COMP-3004", course: "Intro to Artificial Intelligence",   deadline: "Oct 23",       weight: "33.3%", status: "todo" },
  { id: "t3-d2", title: "Assessment 2", courseCode: "COMP-3004", course: "Intro to Artificial Intelligence",   deadline: "Nov 27",       weight: "33.3%", status: "todo" },
  { id: "t3-d3", title: "Assessment 3", courseCode: "COMP-3004", course: "Intro to Artificial Intelligence",   deadline: "Jan 10, 2027", weight: "33.3%", status: "todo" },
  { id: "t3-e1", title: "Assessment 1", courseCode: "COMP-3005", course: "Business Strategy",                  deadline: "Oct 18",       weight: "25%",   status: "todo" },
  { id: "t3-e2", title: "Assessment 2", courseCode: "COMP-3005", course: "Business Strategy",                  deadline: "Nov 1",        weight: "25%",   status: "todo" },
  { id: "t3-e3", title: "Assessment 3", courseCode: "COMP-3005", course: "Business Strategy",                  deadline: "Nov 29",       weight: "25%",   status: "todo" },
  { id: "t3-e4", title: "Assessment 4", courseCode: "COMP-3005", course: "Business Strategy",                  deadline: "Jan 3, 2027",  weight: "25%",   status: "todo" },
  // ── TERM 4 ──────────────────────────────────────────────────────────────
...
export const initialPractices: Practice[] = [
  ...
  // ── COMP-3001 Introduction to Databases — 10 Practice Quizzes ─────────
  { id: "p-3001-q1",  courseCode: "COMP-3001", course: "Introduction to Databases", type: "quiz", title: "Practice Quiz 1",  completed: false },
  { id: "p-3001-q2",  courseCode: "COMP-3001", course: "Introduction to Databases", type: "quiz", title: "Practice Quiz 2",  completed: false },
  { id: "p-3001-q3",  courseCode: "COMP-3001", course: "Introduction to Databases", type: "quiz", title: "Practice Quiz 3",  completed: false },
  { id: "p-3001-q4",  courseCode: "COMP-3001", course: "Introduction to Databases", type: "quiz", title: "Practice Quiz 4",  completed: false },
  { id: "p-3001-q5",  courseCode: "COMP-3001", course: "Introduction to Databases", type: "quiz", title: "Practice Quiz 5",  completed: false },
  { id: "p-3001-q6",  courseCode: "COMP-3001", course: "Introduction to Databases", type: "quiz", title: "Practice Quiz 6",  completed: false },
  { id: "p-3001-q7",  courseCode: "COMP-3001", course: "Introduction to Databases", type: "quiz", title: "Practice Quiz 7",  completed: false },
  { id: "p-3001-q8",  courseCode: "COMP-3001", course: "Introduction to Databases", type: "quiz", title: "Practice Quiz 8",  completed: false },
  { id: "p-3001-q9",  courseCode: "COMP-3001", course: "Introduction to Databases", type: "quiz", title: "Practice Quiz 9",  completed: false },
  { id: "p-3001-q10", courseCode: "COMP-3001", course: "Introduction to Databases", type: "quiz", title: "Practice Quiz 10", completed: false },
  // ── COMP-3002 Cloud Computing Infrastructure — 12 Practice Quizzes ────
  { id: "p-3002-q1",  courseCode: "COMP-3002", course: "Cloud Computing Infrastructure", type: "quiz", title: "Practice Quiz 1",  completed: false },
  { id: "p-3002-q2",  courseCode: "COMP-3002", course: "Cloud Computing Infrastructure", type: "quiz", title: "Practice Quiz 2",  completed: false },
  { id: "p-3002-q3",  courseCode: "COMP-3002", course: "Cloud Computing Infrastructure", type: "quiz", title: "Practice Quiz 3",  completed: false },
  { id: "p-3002-q4",  courseCode: "COMP-3002", course: "Cloud Computing Infrastructure", type: "quiz", title: "Practice Quiz 4",  completed: false },
  { id: "p-3002-q5",  courseCode: "COMP-3002", course: "Cloud Computing Infrastructure", type: "quiz", title: "Practice Quiz 5",  completed: false },
  { id: "p-3002-q6",  courseCode: "COMP-3002", course: "Cloud Computing Infrastructure", type: "quiz", title: "Practice Quiz 6",  completed: false },
  { id: "p-3002-q7",  courseCode: "COMP-3002", course: "Cloud Computing Infrastructure", type: "quiz", title: "Practice Quiz 7",  completed: false },
  { id: "p-3002-q8",  courseCode: "COMP-3002", course: "Cloud Computing Infrastructure", type: "quiz", title: "Practice Quiz 8",  completed: false },
  { id: "p-3002-q9",  courseCode: "COMP-3002", course: "Cloud Computing Infrastructure", type: "quiz", title: "Practice Quiz 9",  completed: false },
  { id: "p-3002-q10", courseCode: "COMP-3002", course: "Cloud Computing Infrastructure", type: "quiz", title: "Practice Quiz 10", completed: false },
  { id: "p-3002-q11", courseCode: "COMP-3002", course: "Cloud Computing Infrastructure", type: "quiz", title: "Practice Quiz 11", completed: false },
  { id: "p-3002-q12", courseCode: "COMP-3002", course: "Cloud Computing Infrastructure", type: "quiz", title: "Practice Quiz 12", completed: false },
  // ── COMP-3003 Programming Paradigms — 11 Practice Quizzes ─────────────
  { id: "p-3003-q1",  courseCode: "COMP-3003", course: "Programming Paradigms", type: "quiz", title: "Practice Quiz 1",  completed: false },
  { id: "p-3003-q2",  courseCode: "COMP-3003", course: "Programming Paradigms", type: "quiz", title: "Practice Quiz 2",  completed: false },
  { id: "p-3003-q3",  courseCode: "COMP-3003", course: "Programming Paradigms", type: "quiz", title: "Practice Quiz 3",  completed: false },
  { id: "p-3003-q4",  courseCode: "COMP-3003", course: "Programming Paradigms", type: "quiz", title: "Practice Quiz 4",  completed: false },
  { id: "p-3003-q5",  courseCode: "COMP-3003", course: "Programming Paradigms", type: "quiz", title: "Practice Quiz 5",  completed: false },
  { id: "p-3003-q6",  courseCode: "COMP-3003", course: "Programming Paradigms", type: "quiz", title: "Practice Quiz 6",  completed: false },
  { id: "p-3003-q7",  courseCode: "COMP-3003", course: "Programming Paradigms", type: "quiz", title: "Practice Quiz 7",  completed: false },
  { id: "p-3003-q8",  courseCode: "COMP-3003", course: "Programming Paradigms", type: "quiz", title: "Practice Quiz 8",  completed: false },
  { id: "p-3003-q9",  courseCode: "COMP-3003", course: "Programming Paradigms", type: "quiz", title: "Practice Quiz 9",  completed: false },
  { id: "p-3003-q10", courseCode: "COMP-3003", course: "Programming Paradigms", type: "quiz", title: "Practice Quiz 10", completed: false },
  { id: "p-3003-q11", courseCode: "COMP-3003", course: "Programming Paradigms", type: "quiz", title: "Practice Quiz 11", completed: false },
  // ── COMP-3004 Intro to Artificial Intelligence — 9 Practice Quizzes ───
  { id: "p-3004-q1", courseCode: "COMP-3004", course: "Intro to Artificial Intelligence", type: "quiz", title: "Practice Quiz 1", completed: false },
  { id: "p-3004-q2", courseCode: "COMP-3004", course: "Intro to Artificial Intelligence", type: "quiz", title: "Practice Quiz 2", completed: false },
  { id: "p-3004-q3", courseCode: "COMP-3004", course: "Intro to Artificial Intelligence", type: "quiz", title: "Practice Quiz 3", completed: false },
  { id: "p-3004-q4", courseCode: "COMP-3004", course: "Intro to Artificial Intelligence", type: "quiz", title: "Practice Quiz 4", completed: false },
  { id: "p-3004-q5", courseCode: "COMP-3004", course: "Intro to Artificial Intelligence", type: "quiz", title: "Practice Quiz 5", completed: false },
  { id: "p-3004-q6", courseCode: "COMP-3004", course: "Intro to Artificial Intelligence", type: "quiz", title: "Practice Quiz 6", completed: false },
  { id: "p-3004-q7", courseCode: "COMP-3004", course: "Intro to Artificial Intelligence", type: "quiz", title: "Practice Quiz 7", completed: false },
  { id: "p-3004-q8", courseCode: "COMP-3004", course: "Intro to Artificial Intelligence", type: "quiz", title: "Practice Quiz 8", completed: false },
  { id: "p-3004-q9", courseCode: "COMP-3004", course: "Intro to Artificial Intelligence", type: "quiz", title: "Practice Quiz 9", completed: false },
  // ── COMP-3005 Business Strategy — 7 Practice Quizzes ──────────────────
  { id: "p-3005-q1", courseCode: "COMP-3005", course: "Business Strategy", type: "quiz", title: "Practice Quiz 1", completed: false },
  { id: "p-3005-q2", courseCode: "COMP-3005", course: "Business Strategy", type: "quiz", title: "Practice Quiz 2", completed: false },
  { id: "p-3005-q3", courseCode: "COMP-3005", course: "Business Strategy", type: "quiz", title: "Practice Quiz 3", completed: false },
  { id: "p-3005-q4", courseCode: "COMP-3005", course: "Business Strategy", type: "quiz", title: "Practice Quiz 4", completed: false },
  { id: "p-3005-q5", courseCode: "COMP-3005", course: "Business Strategy", type: "quiz", title: "Practice Quiz 5", completed: false },
  { id: "p-3005-q6", courseCode: "COMP-3005", course: "Business Strategy", type: "quiz", title: "Practice Quiz 6", completed: false },
  { id: "p-3005-q7", courseCode: "COMP-3005", course: "Business Strategy", type: "quiz", title: "Practice Quiz 7", completed: false },
]
...
export const TERM_COURSES: Record<Term, Course[]> = {
  ...
  "Term 3": [
    { code: "COMP-3001", name: "Introduction to Databases",          color: "#0891B2" },
    { code: "COMP-3002", name: "Cloud Computing Infrastructure",     color: "#059669" },
    { code: "COMP-3003", name: "Programming Paradigms",              color: "#6366F1" },
    { code: "COMP-3004", name: "Intro to Artificial Intelligence",   color: "#D97706" },
    { code: "COMP-3005", name: "Business Strategy",                  color: "#DC2626" },
  ],
  "Term 4": [
